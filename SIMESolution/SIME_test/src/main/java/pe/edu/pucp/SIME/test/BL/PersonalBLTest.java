...
public class PersonalBLTest {
    public static void main(String[] args){
        ...
        try {
            ...
            nuevoProfesor.setDni("70000012");
            nuevoProfesor.setNombres("Juan");
            nuevoProfesor.setApellidoPaterno("Martinez");
            nuevoProfesor.setApellidoMaterno("Santos");
            nuevoProfesor.setTipo(TipoPersona.PROFESOR);
            nuevoProfesor.setEspecialidad("Quimica");
            nuevoProfesor.setTelefono("99999999");
